package com.androidproject1.mabele.irent;
...
public class MainActivity extends AppCompatActivity {
    ...
    EditText First_Name, Last_Name, Username, Id_number, User, Phone_number, Email, Password ;
    String F_Name_Holder, L_Name_Holder, Username_Holder, Id_Holder, Phone_Holder,  EmailHolder, PasswordHolder;
    String finalResult ;
    String HttpURL = "http://54.224.229.75/sharon_dissertation/include/userRegistration.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Id_number = (EditText)findViewById(R.id.idnumber);
        User = (EditText)findViewById(R.id.spinner1);
